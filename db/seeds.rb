...
Tag.create!(name:'テストa')
Tag.create!(name:'テストb')
Tag.create!(name:'テストc')
Tag.create!(name:'テストd')
Tag.create!(name:'テストe')
Tag.create!(name:'テストf')
Tag.create!(name:'テストg')
Tag.create!(name:'テストh')
Tag.create!(name:'テストi')
Tag.create!(name:'テストj')
